...
figure
subplot(1,2,1)
plot(x1,day1low,'^','LineWidth',3,'MarkerSize',10,'Color',[0.6350, 0.0780, 0.1840])
hold on
plot(x1,day2low,'o ','LineWidth',3,'MarkerSize',10,'Color',[0.109, 0.5625, 0.7852])
...
high2_chanmean= squeeze(mean(high2_sessmean(chansel,:,2,:),1)); % 6 channel * 10 stim
