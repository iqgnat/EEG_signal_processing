function  [h]=beautiful_NF(time, NF_mean, NF_std,FBandName,nbplot,totalgroup,totalstat,color,marker)
...
plot(time(1:5), NF_mean(1:5),[marker,'-'],'Color',color,'Linewidth',2);
h=plot(time(6:10), NF_mean(6:10),[marker,'-'],'Color',color,'Linewidth',2);
hold off
% edit y axis
if nbplot==3
    ylim([2.3,3]);
